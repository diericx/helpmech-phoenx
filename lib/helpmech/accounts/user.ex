defmodule Helpmech.Accounts.User do
  use Ecto.Schema
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, Helpmech.Repo)
  ...
  """
  def valid_password?(%Helpmech.Accounts.User{hashed_password: hashed_password}, password)
