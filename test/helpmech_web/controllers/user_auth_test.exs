defmodule HelpmechWeb.UserAuthTest do
  use HelpmechWeb.ConnCase, async: true

  alias Helpmech.Accounts
  alias HelpmechWeb.UserAuth
  import Helpmech.AccountsFixtures

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, HelpmechWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      HelpmechWeb.Endpoint.subscribe(live_socket_id)
